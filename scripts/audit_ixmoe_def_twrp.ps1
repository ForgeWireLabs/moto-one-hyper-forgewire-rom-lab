param(
  [string]$CandidatePath = "C:\Projects\moto-one-hyper-local\sources\ixmoe_android_device_motorola_def_twrp",
...
$lines = @()
$lines += "# Source Audit: ixmoe android_device_motorola_def_twrp"
$lines += ""
...
$lines += ""
$lines += "Reason: this candidate is named and structured as a TWRP/recovery device tree for Motorola ``def``. It may contain useful recovery, fstab, BoardConfig, partition, and image-layout clues, but it is not a complete custom ROM device tree by itself."
$lines += ""
...
$lines += ""
$lines += "Next recommended audit: ``Nandru86_android_device_motorola_def_twrp``."
