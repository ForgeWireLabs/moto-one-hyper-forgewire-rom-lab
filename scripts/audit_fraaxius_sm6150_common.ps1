param(
  [string]$CandidatePath = "C:\Projects\moto-one-hyper-local\sources\Fraaxius_device_motorola_sm6150-common",
  [string]$ReportPath = "reports\source_audit_fraaxius_sm6150_common.md"
)
...
$lines = @()
$lines += "# Source Audit: Fraaxius device_motorola_sm6150-common"
$lines += ""
...
$lines += ""
$lines += "Reason: this candidate is named and structured as a shared Motorola ``sm6150-common`` tree. It may contain SoC/common BoardConfig, sepolicy, init, vendor, kernel, and shared-device assumptions. It is not device-specific enough to accept as a build input by itself."
$lines += ""
...
$lines += ""
$lines += "Next recommended step: create an evidence matrix across TWRP, stock def, and sm6150-common candidates."
