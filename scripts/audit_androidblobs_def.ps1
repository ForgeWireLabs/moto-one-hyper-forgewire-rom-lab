param(
  [string]$CandidatePath = "C:\Projects\moto-one-hyper-local\sources\AndroidBlobs_device_motorola_def",
  [string]$ReportPath = "reports\source_audit_androidblobs_def.md"
)
...
$lines = @()
$lines += "# Source Audit: AndroidBlobs device_motorola_def"
$lines += ""
...
$lines += ""
$lines += "Next recommended audit: ``ludevjhon_device_motorola_def``."
