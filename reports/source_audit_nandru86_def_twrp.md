# Source Audit: Nandru86 android_device_motorola_def_twrp
...
| Field | Value |
|---|---|
| Local path | C:\Projects\moto-one-hyper-local\sources\Nandru86_android_device_motorola_def_twrp |
...
Next recommended audit: `AndroidBlobs_device_motorola_def`.
