# Source Audit: ludevjhon device_motorola_def
...
| Field | Value |
|---|---|
| Local path | C:\Projects\moto-one-hyper-local\sources\ludevjhon_device_motorola_def |
...
- `BoardConfig.mk` line 17: `BOARD_KERNEL_CMDLINE := console=ttyMSM0,115200n8 androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=1 androidboot.usbcontroller=a600000.dwc3 earlycon=msm_geni_serial,0x880000 loop.max_part=7 printk.devkmsg=on firmware_class.path=/vendor/firmware_mnt/image`
- `BoardConfig.mk` line 18: `BOARD_KERNEL_BASE := 0x00000000`
- `BoardConfig.mk` line 19: `BOARD_KERNEL_PAGESIZE := 4096`
- `BoardConfig.mk` line 20: `BOARD_KERNEL_TAGS_OFFSET := 0x00000100`
- `BoardConfig.mk` line 21: `BOARD_RAMDISK_OFFSET     := 0x01000000`
- `BoardConfig.mk` line 24: `BOARD_KERNEL_IMAGE_NAME := Image.gz-dtb`
- `BoardConfig.mk` line 27: `BOARD_KERNEL_SEPARATED_DTBO := true`
- `BoardConfig.mk` line 36: `BOARD_KERNEL_SEPARATED_DTBO := true`
- `BoardConfig.mk` line 38: `BOARD_ROOT_EXTRA_FOLDERS += firmware firmware/radio persist bt_firmware`
- `BoardConfig.mk` line 39: `BOARD_ROOT_EXTRA_SYMLINKS += /vendor/lib/dsp:/dsp`
- `BoardConfig.mk` line 40: `BOARD_ROOT_EXTRA_SYMLINKS += /vendor/firmware_mnt/image:/firmware/image`
- `BoardConfig.mk` line 41: `BOARD_ROOT_EXTRA_SYMLINKS += /vendor/firmware_mnt/verinfo:/firmware/verinfo`
- `BoardConfig.mk` line 43: `BOARD_VENDORIMAGE_PARTITION_SIZE := 209715200`
- `BoardConfig.mk` line 44: `BOARD_BOOTIMAGE_PARTITION_SIZE := 67108864`
- `BoardConfig.mk` line 45: `BOARD_RECOVERYIMAGE_PARTITION_SIZE := 67108864`
- `BoardConfig.mk` line 46: `BOARD_USERDATAIMAGE_PARTITION_SIZE := 10737418240`
- `BoardConfig.mk` line 47: `BOARD_DTBOIMG_PARTITION_SIZE := 25165824`
- `BoardConfig.mk` line 48: `BOARD_PERSISTIMAGE_FILE_SYSTEM_TYPE := ext4`
- `BoardConfig.mk` line 49: `BOARD_FLASH_BLOCK_SIZE := 131072 # (BOARD_KERNEL_PAGESIZE * 64)`
- Additional hits omitted from first-pass report: 6
...
- `BoardConfig.mk` line 4: `TARGET_ARCH := arm64`
- `BoardConfig.mk` line 5: `TARGET_ARCH_VARIANT := armv8-a`
- `BoardConfig.mk` line 6: `TARGET_CPU_ABI := arm64-v8a`
- `BoardConfig.mk` line 7: `TARGET_CPU_ABI2 :=`
- `BoardConfig.mk` line 8: `TARGET_CPU_VARIANT := generic`
- `BoardConfig.mk` line 10: `TARGET_2ND_ARCH := arm`
- `BoardConfig.mk` line 11: `TARGET_2ND_ARCH_VARIANT := armv7-a-neon`
- `BoardConfig.mk` line 12: `TARGET_2ND_CPU_ABI := armeabi-v7a`
- `BoardConfig.mk` line 13: `TARGET_2ND_CPU_ABI2 := armeabi`
- `BoardConfig.mk` line 14: `TARGET_2ND_CPU_VARIANT := cortex-a9`
- `BoardConfig.mk` line 22: `TARGET_KERNEL_ARCH := arm64`
- `BoardConfig.mk` line 23: `TARGET_KERNEL_HEADER_ARCH := arm64`
- `BoardConfig.mk` line 25: `TARGET_KERNEL_SOURCE := kernel/motorola/sm6150`
- `BoardConfig.mk` line 26: `TARGET_KERNEL_CONFIG := vendor/lineage_def_defconfig`
- `BoardConfig.mk` line 28: `TARGET_KERNEL_ADDITIONAL_FLAGS := \`
- `BoardConfig.mk` line 31: `TARGET_KERNEL_VERSION := 4.14`
- `BoardConfig.mk` line 32: `TARGET_KERNEL_CLANG_COMPILE := true`
- `BoardConfig.mk` line 33: `TARGET_KERNEL_CLANG_VERSION := r328903`
- `BoardConfig.mk` line 60: `TARGET_SPECIFIC_HEADER_PATH := $(DEVICE_PATH)/include`
- Additional hits omitted from first-pass report: 182
...
- `BoardConfig.mk` line 26: `TARGET_KERNEL_CONFIG := vendor/lineage_def_defconfig`
- `BoardConfig.mk` line 29: `DTC=$(OUT_DIR)/../device/motorola/def/dtc/dtc`
- `BoardConfig.mk` line 77: `-include vendor/motorola/def/BoardConfigVendor.mk`
...
- Additional hits omitted from first-pass report: 408
...
- Additional hits omitted from first-pass report: 233
...
- `BoardConfig.mk` line 53: `BOARD_SUPER_PARTITION_SIZE := 9730785280`
- `BoardConfig.mk` line 54: `BOARD_SUPER_PARTITION_GROUPS := qti_dynamic_partitions`
...
- `BoardConfig.mk` line 54: `BOARD_SUPER_PARTITION_GROUPS := qti_dynamic_partitions`
- `BoardConfig.mk` line 55: `BOARD_QTI_DYNAMIC_PARTITIONS_SIZE := 4861198336`
- `BoardConfig.mk` line 56: `BOARD_QTI_DYNAMIC_PARTITIONS_PARTITION_LIST := \`
...
- Additional hits omitted from first-pass report: 432
...
- `lineage_def.mk` line 11: `PRODUCT_BRAND := motorola`
- `lineage_def.mk` line 13: `PRODUCT_MANUFACTURER := motorola`
- Additional hits omitted from first-pass report: 71
...
Next recommended audit: `Fraaxius_device_motorola_sm6150-common`.
